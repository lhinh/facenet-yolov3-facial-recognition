...
class YOLO(object):
    def __init__(self):
        # self.args = args
        self.score_threshold = 0.5 # Default values from source
        self.iou_threshold = 0.45 # Default values from source
        self.model_path = './yolo_face/YOLO_Face.h5'
        self.classes_path = './yolo_face/face_classes.txt'
        self.anchors_path = './yolo_face/yolo_anchors.txt'
        ...
        self.model_image_size = (416, 416) # Default values from source
    ...
    def detect_image(self, image):
        ...
        # I think this code block draws bounding boxes on the image. Remove?
